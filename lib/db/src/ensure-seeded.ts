...
const ARTICLE_BODY_AI_SEARCH = `<p>For more than two decades, the internet has had a single front door: a blank text box with a colorful logo. You type a keyword, hit enter, and get a list of ten blue links. It is a ritual so deeply ingrained in our lives that "googling" became a verb. But that era is ending.</p>
...
const ARTICLE_BODY_AI_SLOP = `<p>If you have spent any time scrolling through social media or searching the web recently, you have likely run into it. You search for an article, only to find a page of repetitive, generic text that reads like a robot wrote it. You scroll past images that look almost real, but have slightly melted fingers and perfect, glassy surfaces. This is "AI slop."</p>
...
<p>For students, the implications are particularly interesting. Our breakdown of <a href="/article/ai-tools-for-students-2026" class="article-backlink">how AI tools are changing the way students study in 2026</a> covers exactly this — and shows how the AI phone and AI study tool revolution are converging.</p>`,
  ...
  },
  {
    ...
    body: ARTICLE_BODY_AI_SEARCH,
    category: "Tech",
    authorId: 1,
    publishedAt: new Date("2026-05-27T08:00:00Z"),
    readTime: 8,
    imageUrl: "https://images.pexels.com/photos/3762800/pexels-photo-3762800.jpeg?auto=compress&cs=tinysrgb&w=1200",
    views: 0,
    featured: false,
    editorsPick: true,
  ...
  },
  {
    ...
    body: ARTICLE_BODY_SMART_GLASSES,
    category: "Tech",
    authorId: 2,
    publishedAt: new Date("2026-05-27T09:30:00Z"),
    readTime: 7,
  ...
  },
  {
    ...
    body: ARTICLE_BODY_AI_SLOP,
    category: "Culture",
    authorId: 3,
    publishedAt: new Date("2026-05-27T11:00:00Z"),
    readTime: 8,
    imageUrl: "https://images.pexels.com/photos/5905709/pexels-photo-5905709.jpeg?auto=compress&cs=tinysrgb&w=1200",
    views: 0,
    featured: false,
  ...
  },
  {
    ...
    body: ARTICLE_BODY_DIGITAL_DETOX_JOMO,
    category: "Lifestyle",
    authorId: 3,
    publishedAt: new Date("2026-05-27T13:00:00Z"),
    readTime: 7,
    imageUrl: "https://images.pexels.com/photos/3772612/pexels-photo-3772612.jpeg?auto=compress&cs=tinysrgb&w=1200",
    views: 0,
    featured: false,
    editorsPick: false,
